<%@ Control Language="C#" AutoEventWireup="true" CodeFile="BAOCAOTONGHOP.ascx.cs"
    Inherits="module_BAOCAOTONGHOP" %>
<%@ Register TagPrefix="uc1" Namespace="ITCLIB.Admin" %>
<telerik:RadCodeBlock ID="RadCodeBlockBAOCAOTONGHOP" runat="server">
    <script type="text/javascript">
        ...
        function GetGridServerElementNG(serverID, tagName) {
            ...
            var grid = $get("<%=RadGridBAOCAOTONGHOP.ClientID %>");
...
<telerik:RadGrid ID="RadGridBAOCAOTONGHOP" runat="server" Skin="Vista" AllowPaging="True"
    ...
    OnDataBound="RadGridBAOCAOTONGHOP_DataBound" CellSpacing="0" OnExcelMLExportRowCreated="RadGridBAOCAOTONGHOP_ExcelMLExportRowCreated"
    ...
    <MasterTableView Name="MasterTableViewBAOCAOTONGHOP" CommandItemDisplay="Top" DataSourceID="BAOCAOTONGHOPDataSource"
        ...
        <Columns>
            ...
            <telerik:GridBoundColumn UniqueName="C_COD" HeaderText="COD" DataField="C_COD" HeaderStyle-Width="100px"
            ...
            <telerik:GridBoundColumn UniqueName="C_BAOPHAT" HeaderText="Báo phát" DataField="C_BAOPHAT"
                HeaderStyle-Width="100px" HeaderStyle-HorizontalAlign="Center" AutoPostBackOnFilter="true"
                CurrentFilterFunction="Contains" FilterControlWidth="75%" DataType="System.Decimal"
                DataFormatString="{0:### ### ###}">
            </telerik:GridBoundColumn>
