<%@ Control Language="C#" AutoEventWireup="true" CodeFile="SOQUYTIENMATV3.ascx.cs"
    Inherits="module_SOQUYTIENMATV3" %>
...
<telerik:RadCodeBlock ID="RadCodeBlockSOQUYTIENMATV3" runat="server">
    ...
    <script type="text/javascript">
        ...
        function GetGridServerElementNG(serverID, tagName) {
            ...
            var grid = $get("<%=RadGridSOQUYTIENMATV3.ClientID %>");
...
<telerik:RadAjaxLoadingPanel Skin="Vista" ID="RadAjaxLoadingPanelSOQUYTIENMATV3" runat="server" />
<telerik:RadAjaxPanel ID="RadAjaxPanelSOQUYTIENMATV3" runat="server" Height="200px"
    Width="100%">
    <style type="text/css">
        table.gridtable
        {
    ...
    <telerik:RadGrid ID="RadGridSOQUYTIENMATV3" runat="server" Skin="Vista" AllowPaging="True"
        ...
        AllowAutomaticInserts="True" AllowAutomaticUpdates="True" DataSourceID="SOQUYTIENMATV3DataSource"
        ...
        <MasterTableView Name="MasterTableViewSOQUYTIENMATV3" CommandItemDisplay="Top" DataSourceID="SOQUYTIENMATV3DataSource"
            ...
            <CommandItemTemplate>
                <div style="padding: 5px 5px; float: left; width: auto">
                    ...
                    <asp:LinkButton ID="btnEditSelected" runat="server" CommandName="EditSelected" Visible='<%# RadGridSOQUYTIENMATV3.EditIndexes.Count == 0 && ITCLIB.Security.Security.CanEditModule("TAICHINH") %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/Edit.gif" />Sửa</asp:LinkButton>&nbsp;&nbsp;
                    <asp:LinkButton ID="btnUpdateEdited" runat="server" CommandName="UpdateEdited" Visible='<%# RadGridSOQUYTIENMATV3.EditIndexes.Count > 0 %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/Update.gif" />Lưu</asp:LinkButton>&nbsp;&nbsp;
                    <asp:LinkButton ID="btnCancel" runat="server" CommandName="CancelAll" Visible='<%# RadGridSOQUYTIENMATV3.EditIndexes.Count > 0 || RadGridSOQUYTIENMATV3.MasterTableView.IsItemInserted %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/Cancel.gif" />Hủy bỏ</asp:LinkButton>&nbsp;&nbsp;
                    <asp:LinkButton ID="LinkButton2" runat="server" CommandName="InitInsert" Visible='<%# !RadGridSOQUYTIENMATV3.MasterTableView.IsItemInserted && ITCLIB.Security.Security.CanAddModule("TAICHINH") %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/AddRecord.gif" />Thêm</asp:LinkButton>&nbsp;&nbsp;
                    <asp:LinkButton ID="LinkButton3" runat="server" CommandName="PerformInsert" Visible='<%# RadGridSOQUYTIENMATV3.MasterTableView.IsItemInserted %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/Insert.gif" />Lưu</asp:LinkButton>&nbsp;&nbsp;
...
<asp:SqlDataSource ID="SOQUYTIENMATV3DataSource" runat="server" ConnectionString="<%$ ConnectionStrings:ExpressSoftConnectionString %>"
