<%@ Control Language="C#" AutoEventWireup="true" CodeFile="MASANPHAM.ascx.cs" Inherits="module_MASANPHAM" %>
<telerik:RadCodeBlock ID="RadCodeBlockMASANPHAM" runat="server">
<script type="text/javascript">
        function RowDblClick(sender, eventArgs) {
            var CanEdit = "<%=ITCLIB.Security.Security.CanEditModule("Lists") %>";
            if ((eventArgs.get_tableView().get_name() == "MasterTableViewMASANPHAM") && (CanEdit == "True")) {
                sender.get_masterTableView().editItem(eventArgs.get_itemIndexHierarchical());
            }
        }
</script>
</telerik:RadCodeBlock>
<telerik:RadAjaxLoadingPanel Skin="Vista" ID="RadAjaxLoadingPanelMASANPHAM" runat="server" />
<telerik:RadGrid ID="RadGridMASANPHAM" runat="server" Skin="Vista" 
    AllowPaging="True" PageSize="20" AllowSorting="True" 
    AllowFilteringByColumn="True" GridLines="None" ShowStatusBar="True"
    AutoGenerateColumns="False"  
    AllowMultiRowEdit="True" AllowAutomaticDeletes="True" 
    AllowAutomaticInserts="True" AllowAutomaticUpdates="True" 
    DataSourceID="MASANPHAMDataSource" ShowFooter="True"
    ondatabound="RadGridMASANPHAM_DataBound" 
    onitemdeleted="RadGridMASANPHAM_ItemDeleted" oniteminserted="RadGridMASANPHAM_ItemInserted" 
    onitemupdated="RadGridMASANPHAM_ItemUpdated" 
    onitemcommand="RadGridMASANPHAM_ItemCommand" 
    onitemdatabound="RadGridMASANPHAM_ItemDataBound" CellSpacing="0">
    ...
    <MasterTableView Name="MasterTableViewMASANPHAM" CommandItemDisplay="Top" DataSourceID="MASANPHAMDataSource" DataKeyNames="PK_ID" ClientDataKeyNames="PK_ID" EditMode="PopUp" NoMasterRecordsText="Không có dữ liệu">
        <CommandItemTemplate>
                    <div style="padding: 5px 5px;float:left;width:auto">
                        ...
                        <asp:LinkButton ID="LinkButton2" runat="server" CommandName="InitInsert" Visible='<%# !RadGridMASANPHAM.MasterTableView.IsItemInserted && ITCLIB.Security.Security.CanAddModule("JobLists") %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/AddRecord.gif" />Thêm</asp:LinkButton>&nbsp;&nbsp;
                        <asp:LinkButton ID="LinkButton3" runat="server" CommandName="PerformInsert" Visible='<%# RadGridMASANPHAM.MasterTableView.IsItemInserted %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/Insert.gif" />Lưu</asp:LinkButton>&nbsp;&nbsp;
