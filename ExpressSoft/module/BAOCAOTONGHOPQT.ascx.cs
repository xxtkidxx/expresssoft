...
public partial class module_BAOCAOTONGHOPQT : System.Web.UI.UserControl
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        {
            case "IE6":
                RadGridBAOCAOTONGHOPQT.MasterTableView.EditFormSettings.PopUpSettings.Modal = false;
                break;
            case "IE7":
                RadGridBAOCAOTONGHOPQT.MasterTableView.EditFormSettings.PopUpSettings.Modal = false;
                break;
            default:
                RadGridBAOCAOTONGHOPQT.MasterTableView.EditFormSettings.PopUpSettings.Modal = true;
                break;
        }
    ...
    protected void RadGridBAOCAOTONGHOPQT_DataBound(object sender, EventArgs e)
    {
    ...
    {
        if (e.Worksheet.Table.Rows.Count == RadGridBAOCAOTONGHOPQT.Items.Count + 1)
        {
    ...
    protected void RadGridBAOCAOTONGHOPQT_ItemDataBound(object sender, GridItemEventArgs e)
    {
    ...
    protected void RadGridBAOCAOTONGHOPQT_ItemCreated(object sender, GridItemEventArgs e)
    {
        if (e.Item is GridPagerItem)
        {
            ...
            item.Attributes.Add("ownerTableViewId", RadGridBAOCAOTONGHOPQT.MasterTableView.ClientID);
            ...
            cb.Items.FindItemByValue(RadGridBAOCAOTONGHOPQT.PageSize.ToString()).Selected = true;
        }
    }
