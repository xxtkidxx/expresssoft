    ...
    <MasterTableView Name="MasterTableViewNHOMKHACHHANG" CommandItemDisplay="Top" DataSourceID="NHOMKHACHHANGDataSource" DataKeyNames="PK_ID" ClientDataKeyNames="PK_ID" EditMode="PopUp" NoMasterRecordsText="Không có dữ liệu">
        <CommandItemTemplate>
                    <div style="padding: 5px 5px;float:left;width:auto">
                        ...
                        <asp:LinkButton ID="btnEditSelected" runat="server" CommandName="EditSelected" Visible='<%# RadGridNHOMKHACHHANG.EditIndexes.Count == 0 && ITCLIB.Security.Security.CanEditModule("KHACHHANG") %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/Edit.gif" />Sửa</asp:LinkButton>&nbsp;&nbsp;
                        ...
                        <asp:LinkButton ID="LinkButton2" runat="server" CommandName="InitInsert" Visible='<%# !RadGridNHOMKHACHHANG.MasterTableView.IsItemInserted && ITCLIB.Security.Security.CanAddModule("KHACHHANG") %>'><img style="border:0px;vertical-align:middle;" alt="" src="Images/Grid/AddRecord.gif" />Thêm</asp:LinkButton>&nbsp;&nbsp;
