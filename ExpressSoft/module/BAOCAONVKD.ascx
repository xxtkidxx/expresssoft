...
<div style="width: 90%; margin: 10px 10px 10px 10px;">
    ...
    <telerik:RadComboBox ID="cmbNVKD" runat="server" DataTextField="C_NAME" DataValueField="PK_ID"
...
<telerik:RadGrid ID="RadGridBAOCAONVKD" runat="server" Skin="Vista" AllowPaging="True"
    PageSize="50" AllowSorting="True" AllowFilteringByColumn="True" GridLines="None"
    ShowStatusBar="True" AutoGenerateColumns="False" OnItemCommand="RadGridBAOCAONVKD_ItemCommand"
    AllowMultiRowEdit="True" AllowAutomaticDeletes="True" AllowAutomaticInserts="True"
    AllowAutomaticUpdates="True" DataSourceID="BAOCAONVKDDataSource" ShowFooter="True"
    OnDataBound="RadGridBAOCAONVKD_DataBound" CellSpacing="0" OnExcelMLExportRowCreated="RadGridBAOCAONVKD_ExcelMLExportRowCreated"
    OnItemDataBound="RadGridBAOCAONVKD_ItemDataBound" OnItemCreated="RadGridBAOCAONVKD_ItemCreated">
    ...
    <MasterTableView Name="MasterTableViewBAOCAONVKD" CommandItemDisplay="Top" DataSourceID="BAOCAONVKDDataSource"
        DataKeyNames="PK_ID" ClientDataKeyNames="PK_ID" EditMode="PopUp" NoMasterRecordsText="Không có dữ liệu">
        <CommandItemTemplate>
            <div style="padding: 5px 5px; float: left; width: auto">
                <b>Báo cáo doanh số theo nhân viên kinh doanh</b>&nbsp;&nbsp;&nbsp;&nbsp;
        ...
        <Columns>
            ...
            <telerik:GridBoundColumn UniqueName="C_DIACHINHANFIX" HeaderText="Tỉnh/Quốc Gia"
                DataField="C_DIACHINHANFIX" HeaderStyle-Width="130px" HeaderStyle-HorizontalAlign="Center"
